...
public class LoginFormEasy extends javax.swing.JFrame {

    public LoginFormEasy() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginFormEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginFormEasy().setVisible(true);
            }
        });
    }
